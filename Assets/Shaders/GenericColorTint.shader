...
Shader "Custom/ColorTint/Generic" {
    Properties
    {
        ...
        CGPROGRAM
            ...
            v2f vert(appdata_t IN)
            {
                ...
                OUT.texcoord = IN.texcoord;
                    // Before anything else, tint the sprite.  Note:
                    // this also works on the alpha of the WHOLE
                    // SPRITE.  So it can turn the thing transparent.
            ...
            fixed4 frag(v2f IN) : COLOR
            {
                ...
                // If the colors match the desired IN colors, change
                // them to the desired OUT colors.  Othwerise, leave
                // them alone as the original texColor.
