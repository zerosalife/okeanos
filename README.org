...
- [ ] Dynamic enemy placement.
  - [ ] Add XY limit strata data to LevelController
  - [ ] Add a number of enemies to spawn to the LevelController
  - [ ] Add an intermediary LevelController to control the number of
